function Forum() {
    ...
    this.showTicket = function (id, header, name, description) {   
        ...
        createElement("input", head, {id:"ticket"+j, value:id}, {position:"absolute", left:"5%", top:"5%", height:"30%", width:"20%"}, null, "");
        createElement("input", head, {id:"header"+j, value:header}, {position:"absolute", left:"30%", top:"5%", height:"30%", width:"30%"}, null, "");
        ...
        var statusDiv = createElement("div", tick, {id:"statusDiv"+j}, {position:"absolute", right:"2%", bottom:"62%"}, null, "");
    ...
    function colourRed(i) {
        if(document.getElementById("confirm"+i))
            document.getElementById("divHeader"+i).style.background = "#CD5C5C";
    }
    function colourGreen(i) {
        if(document.getElementById("reject"+i))
            document.getElementById("divHeader"+i).style.background = "#8FBC8F";
    }
    function resetColor(i) {
        if(document.getElementById("reset"+i))
            document.getElementById("divHeader"+i).style.background = "none";
    }
